    ...
    <div className="home-container">
        ...
        <div className="hero-content">
          <h1 className="hero-title">
            <span className="title-with-icon">
              ...
              Mental Health & Stress Support Portal
            </span>
          </h1>
      ...
      <div className="how-it-works">
        ...
        <div className="steps">
          ...
          <div className="arrow"><ArrowRight aria-hidden="true" /></div>
          <div className="step">
      ...
      <div className="problem-solution">
        <div className="problem-card">
          <h3 className="title-with-icon"><GraduationCap aria-hidden="true" /> The Problem</h3>
        ...
        <div className="solution-card">
          <h3 className="title-with-icon"><Lightbulb aria-hidden="true" /> Our Solution</h3>
